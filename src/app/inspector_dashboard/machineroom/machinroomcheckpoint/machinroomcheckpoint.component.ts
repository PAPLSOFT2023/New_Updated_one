...
@Component({
  selector: 'app-machinroomcheckpoint',
  templateUrl: './machinroomcheckpoint.component.html',
  styleUrls: ['./machinroomcheckpoint.component.scss']
})
export class MachinroomcheckpointComponent {

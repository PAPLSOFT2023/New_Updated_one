...
@Component({
  selector: 'app-machineroom',
  templateUrl: './machineroom.component.html',
  styleUrls: ['./machineroom.component.scss']
})
export class MachineroomComponent {
  val :string | null='';
  name:string | null ='';
...
if(responseArray)
{
  ...
  handleCardClick(step: string) {
    ...
    this.router.navigate(['afterlogin', 'machineroomcheckpoint',id,this.document_id,this.unit_no,this.name,this.val]);
  }
}
